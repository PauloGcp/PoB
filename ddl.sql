CREATE TABLE JOGO (ID  SERIAL NOT NULL, DATA VARCHAR(255), ESTOQUE INTEGER, LOCAL VARCHAR(255), PRECO FLOAT, TIME1_NOME VARCHAR(255), TIME2_NOME VARCHAR(255), PRIMARY KEY (ID))
